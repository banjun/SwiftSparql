...
fileprivate enum BiboSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/ontology/bibo/")}
}

fileprivate enum CalSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://www.w3.org/2002/12/cal/icaltzd#")}
}

fileprivate enum CcSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://creativecommons.org/ns#")}
}

fileprivate enum DcSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/dc/elements/1.1/")}
}

fileprivate enum DctSchema: IRIBaseProvider {
...
fileprivate enum GeoSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://www.w3.org/2003/01/geo/wgs84_pos#")}
}

fileprivate enum GeorssSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://www.georss.org/georss")}
}

fileprivate enum GrSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/goodrelations/v1#")}
}

fileprivate enum IcSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://imi.ipa.go.jp/ns/core/rdf#")}
}

fileprivate enum JrrkSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/jrrk#")}
}
...
fileprivate enum PcSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/procurement/public-contracts#")}
}

fileprivate enum QbSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/linked-data/cube#")}
}
...
fileprivate enum SacSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://statdb.nstac.go.jp/lod/sac/C")}
}

fileprivate enum SacsSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://statdb.nstac.go.jp/lod/terms/sacs#")}
}
...
fileprivate enum SdmxConceptSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/linked-data/sdmx/2009/concept#")}
}

fileprivate enum SdmxDimensionSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/linked-data/sdmx/2009/dimension#")}
}

fileprivate enum SdmxMeasureSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/linked-data/sdmx/2009/measure#")}
}

fileprivate enum SkosSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://www.w3.org/2004/02/skos/core#")}
}

fileprivate enum XsdSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://www.w3.org/2001/XMLSchema#")}
}

fileprivate enum RegSchema: IRIBaseProvider {
    static var base: IRIRef {return IRIRef(value: "http://purl.org/metainfo/terms/registry#")}
}
