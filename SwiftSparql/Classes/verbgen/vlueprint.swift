...
public extension TripleBuilder where State: TripleBuilderStateRDFTypeBoundType, State.RDFType == VlueprintVirtualBeing {
    ...
    /// 所属事務所
    func vlueprintOffice(is v: GraphTerm) -> TripleBuilder<State> {
        return appended(verb: VlueprintSchema.verb("office"), value: [.varOrTerm(.term(v))])
    }
    
    /// 所属事務所
    func vlueprintOffice(is v: Var) -> TripleBuilder<State> {
        return appended(verb: VlueprintSchema.verb("office"), value: [.var(v)])
    }
...
public extension TripleBuilder where State: TripleBuilderStateRDFTypeBoundType, State.RDFType == VlueprintPerformingGroup {
    ...
    /// メンバー
    func vlueprintMember(is v: GraphTerm) -> TripleBuilder<State> {
        return appended(verb: VlueprintSchema.verb("member"), value: [.varOrTerm(.term(v))])
    }
    
    /// メンバー
    func vlueprintMember(is v: Var) -> TripleBuilder<State> {
        return appended(verb: VlueprintSchema.verb("member"), value: [.var(v)])
    }
